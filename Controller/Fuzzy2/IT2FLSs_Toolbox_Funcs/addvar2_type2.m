function out=addvar2_type2(it2fls,varType,varName,varRange,varargin)
%   Purpose
...
%         % Create type2 membersihp functions
    ...
    if strcmpi(out.type,'sugeno') && isfield(out,'output') && ~isempty(out.output)
